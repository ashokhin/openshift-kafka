...
``` bash 
bash-4.2$ ping apache-kafka
PING apache-kafka.myproject.svc.cluster.local (172.30.170.131) 56(84) bytes of data.
64 bytes from apache-kafka.myproject.svc.cluster.local (172.30.170.131): icmp_seq=1 ttl=37 time=0.373 ms
...
bash-4.2$ cat config/server.properties 
